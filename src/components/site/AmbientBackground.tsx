...
export default function AmbientBackground() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 flex justify-center pb-[6vh]">
        <p className="font-handwriting text-rose-500/8 text-[clamp(4rem,16vw,14rem)] leading-none whitespace-nowrap select-none">
          {WELCOME_TEXT}
        </p>
      </div>
    </div>
